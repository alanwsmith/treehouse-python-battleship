...
class BoardTest():
    ...
    def test_set_player_name(self):
        ...
        self.assert_equal('error_name_is_too_long',
                          board.set_player_name("asdfghjkloiuytrewqe"))
    ...
    def test_set_ship_coordinates(self):
        ...
        self.assert_equal(
            True, board.verify_coordinates_are_clear(coordinate_list))
    ...
    def test_get_name_of_ship_that_was_just_hit(self):
        ...
        board.ships[0].set_coordinates(
            [(3, 4), (4, 4), (5, 4), (6, 4), (7, 4)])
        board.place_shot('e6')
        self.assert_equal('Aircraft Carrier',
                          board.get_name_of_ship_that_was_just_hit())
