...
class Game():
    ...
    def display_arena(self):
        ...
        print('\n{}\n'.format(constants.BANNERS[
              self.banner].format(**self.current)))
    ...
    def place_ship(self, **kwargs):
        ...
        while True:
            ...
            # Use target_location dict to store all the data necessary for
            # validation
            ...
            if not self.validate_ship_stays_on_grid(**target_location):
                ...
                target_coordinates = self.get_ship_coordinates(
                    **target_location)
                ...
                if not board.verify_coordinates_are_clear(target_coordinates):
                    ...
                    logging.info("Target coords: {}". format(
                        target_coordinates))
    ...
    def set_player_names(self):
        ...
        for num in range(0, 2):
            ...
            while self.banner != 'name_set':
                self.display_arena()
                self.banner = self.boards[
                    num].set_player_name(self.get_input())
                ...
                if self.boards[0].player_name == self.boards[1].player_name:
                    ...
                    self.boards[num].set_player_name(
                        "Player {}".format(num + 1))
    ...
    def start_shooting(self):
        ...
        while True:
            ...
            self.current['last_shot'] = self.raw_coordinates_to_display(
                opponents_board.last_shot())
    ...
    def validate_ship_stays_on_grid(self, **kwargs):
        ...
        column_number = constants.COORDINATE_MAP[
            'columns'][kwargs['front_of_ship'][0]]
